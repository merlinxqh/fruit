package com.fruit.base.framework.utils.json;
/**
...
public class JsonMapper extends ObjectMapper {
	...
	public static <T> T fromJson(String src, Type type) {
		...
		try {
			...
			logger.warn("update json string:" + src + " to object:" + type + " error.", e);
			return null;
		}
	}
	...
	public static <T> T fromJson(byte[] src, Type type) {
		...
		try {
			...
			logger.warn("update json byte:" + src + " to object:" + type + " error.", e);
			return null;
		}
	}
